        ...
        en: {
          ...
          table: {
            ...
            rows: [
              ...
              ['How much + is/are + subject?', 'How much are they?'],
        ...
        ru: {
          ...
          table: {
            ...
            rows: [
              ...
              ['How much + is/are + подлежащее?', 'How much are they?'],
              ['What time + is + it?', 'What time is it?'],
      ...
      right: {
        en: {
          ...
          items: [
            ...
            { english: "How much are these shoes? — They're £40.", russian: 'Сколько стоят эти туфли? — 40 фунтов.', highlight: 'How much are' },
        ...
        en: {
          ...
          table: {
            ...
            rows: [
              ...
              ['How much', 'price', 'How much are these oranges?'],
              ['Why', 'reason', 'Why are you upset?'],
            ],
          },
          notes: [
            'Complete the question word first, then check the order: Wh-word + am/is/are + subject.',
            'Use What in common patterns like "What colour...?" and "What time...?", and How much to ask about price.',
          ],
        },
        ru: {
          ...
          table: {
            ...
            rows: [
              ...
              ['How much', 'цена', 'How much are these oranges?'],
              ['Why', 'причина', 'Why are you upset?'],
            ],
          },
          notes: [
            'Сначала выберите вопросительное слово, затем проверьте порядок: Wh-слово + am/is/are + подлежащее.',
            'What используется в шаблонах вроде "What colour...?" и "What time...?", а How much — когда спрашиваем о цене.',
          ],
        },
      },
      right: {
        en: {
          ...
          questions: [
            ...
            },
            {
              id: 'p3-6',
              type: 'fill-blank',
              prompt: '___ are these oranges? — £1.50 a kilo.',
              translation: 'Сколько стоят эти апельсины? — 1,50 фунта за килограмм.',
              correctAnswer: 'How much',
              explanation: 'Use How much to ask about price.',
            },
            {
              id: 'p3-7',
              type: 'fill-blank',
        ...
        ru: {
          ...
          questions: [
            ...
            },
            {
              ...
              translation: 'Сколько стоят эти апельсины? — 1,50 фунта за килограмм.',
              correctAnswer: 'How much',
              explanation: 'How much используем, когда спрашиваем о цене.',
            },
            {
              id: 'p3-7',
              type: 'fill-blank',
      ...
      content: {
        en: {
          ...
          points: [
            ...
            'Wh- questions: <b>question word + am/is/are + subject</b> → Where is Tom? / How old are you?',
            'Common Wh- words: <b>where, what, who, why, how, how old, how much, what time</b>',
        ...
        ru: {
          ...
          points: [
            ...
            'Wh-вопросы: <b>вопросительное слово + am/is/are + подлежащее</b> → Where is Tom? / How old are you?',
            'Основные вопросительные слова: <b>where, what, who, why, how, how old, how much, what time</b>',
