...
export const UI_STRINGS: Record<string, Record<Language, string>> = {
  ...
  'nav.stepKeyboardHint': {
    en: 'Use Left/Right arrows for steps. Home/End jumps to the first or last step.',
    ru: 'Используйте стрелки влево/вправо для шагов. Home/End переходит к первому или последнему шагу.',
  },
  ...
  'practice.recorded': { en: '✓ Answer recorded', ru: '✓ Ответ записан' },
  'practice.keyboardHint': {
    en: 'Enter checks the current item. Ctrl+Enter or Cmd+Enter checks all filled items.',
    ru: 'Enter проверяет текущий пункт. Ctrl+Enter или Cmd+Enter проверяет все заполненные пункты.',
  },
